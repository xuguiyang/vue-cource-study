              ...
              <div class="prize-list">
                <ul class="ulOne" :class="{'win':indexa === 0 && prize_list.length ==3 }">
                  ...
                  v-for="(item,index) in arrOne"
                    ...
                    :style="{ zIndex: item.zIndex,transform: item.deg }" :key="index"
                  ></li>
                </ul>
  ...
  data() {
    return {
      ...
      prize_list: [
        ...
        { prizeType: 3, prizeName: "奖品111" },
        { prizeType: 2, prizeName: "奖品222" },
        { prizeType: 2, prizeName: "奖品333" },
        { prizeType: 3, prizeName: "奖品444" },
        // { prizeType: 3, prizeName: "奖品555" },
        // { prizeType: 3, prizeName: "奖品666" },
        // { prizeType: 3, prizeName: "奖品777" }
      ], //奖品列表
      arrOne: [],
      arrTwo: [],
      shopUid: "",
